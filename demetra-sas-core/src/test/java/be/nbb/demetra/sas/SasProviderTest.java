 ...
 */
public class SasProviderTest {

    @Test
    public void testTspCompliance() {
        IDataSourceLoaderAssert.assertCompliance(SasProviderTest::getProvider, SasProviderTest::getBean);
    }
    ...
    public void testMonikerUri() {
        ...
        try (IDataSourceProvider p = new SasProvider()) {
